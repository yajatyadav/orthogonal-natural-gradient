...
class NormalNN(nn.Module):
    ...
    def create_model(self):
        ...
        # elif cfg.model_type not in ["mlp", "lenet"] :
        #     model = models.__dict__[cfg['model_type']].__dict__[cfg['model_name']]()
        # else :
        model = models.__dict__[cfg['model_type']].__dict__[cfg['model_name']](hidden_dim=self.config.hidden_dim)
    ...
    def criterion(self, preds, targets, tasks, **kwargs):
        ...
        if self.multihead:
            ...
            pred = preds['All'] # Finally understood this line hahaha ! From dict to tensor :)
    ...
    def get_preds(self, preds, targets, tasks, **kwargs):
        # The inputs and targets could come from single task or a mix of tasks
        # The network always makes the predictions with all its heads
        # The criterion will match the head and task to calculate the loss.
        if self.multihead:
