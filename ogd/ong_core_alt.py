...
from models.mlp import MLP_ONG_PRECOND, MLP_ONG
...
# append EKFAC-pytorch
ekfac_path = os.path.join(root, "EKFAC-pytorch")
if ekfac_path not in sys.path:
    sys.path.insert(0, ekfac_path)

from ekfac import EKFAC



class AgentModel_ONGPRECOND(pl.LightningModule):
    def __init__(self, config, wandb_run, val_loaders):
        print("🐐🐐🐐🐐 Using my AgentModel_ONGPRECOND")
        super().__init__()
        ...
        self.preconditioner = EKFAC(self.model, 0.1, update_freq=100, alpha=1.0)
